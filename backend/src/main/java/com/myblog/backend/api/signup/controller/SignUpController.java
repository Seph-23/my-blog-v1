...
import com.myblog.backend.global.common.dto.CreatedResponseDto;
...
public class SignUpController extends AbstractController {
	...
	@PostMapping("/signup")
	public BusinessResponseDto<CreatedResponseDto> signUp(@Valid @RequestBody SignUpRequestDto signUpRequestDto,
		...
		return created(CreatedResponseDto.builder().location(location).build());
	}
}
